...
int main(int argc, char *argv[])
{
    ...
    SDL_Event event;
    SDL_Rect position1, position2,pos1,pos2,positionback,camera1,camera2;
    int continuer = 1;
...
position2.x=600;
position2.y=0;
	background = IMG_Load("joueurA.psd");
...
case SDL_KEYDOWN:
		...
		{
			case SDLK_UP:
				scroll(&camera1,1,&pos1,position1,position2,surface1);
				pos1.y-=10;
			break;
			case SDLK_DOWN:
				scroll(&camera1,2,&pos1,position1,position2,surface1);
				pos1.y+=10;
			break;
			case SDLK_LEFT:
				scroll(&camera1,3,&pos1,position1,position2,surface1);
				pos1.x-=10;
			break;
			case SDLK_RIGHT:
				scroll(&camera1,4,&pos1,position1,position2,surface1);
				pos1.x+=10;
			break;
			case SDLK_KP8:
				scroll(&camera2,1,&pos2,position2,position1,surface1);
				pos2.y-=10;
			break;
			case SDLK_KP2:
				scroll(&camera2,2,&pos2,position2,position1,surface1);
				pos2.y+=10;
			break;
			case SDLK_KP4:
				scroll(&camera2,3,&pos2,position2,position1,surface1);
				pos2.x-=10;
			break;
			case SDLK_KP6:
				scroll(&camera2,4,&pos2,position2,position1,surface1);
				pos2.x+=10;
			break;
		}
display_scroll(ecran,surface1,camera1);
display_scroll2(ecran,surface1,camera2);
		break;
        }
    }
    SDL_Quit();
